...
type RunDetail = RunSummary & {
  ...
  quality_report: { passed?: boolean; dimension_scores?: Record<string, number>; violations?: { code: string }[]; final_evaluation?: FinalEvaluation };
      ...
      <div className="grid min-h-[calc(100vh-80px)] min-w-0 lg:grid-cols-[280px_minmax(0,1fr)_300px]">
        ...
        <aside className="min-w-0 border-t border-slate-200 bg-white p-5 lg:border-t-0 lg:border-l">
          {selected && <div className="space-y-6">
            ...
            <section><h3 className="mb-3 text-sm font-semibold">Lý do chấm điểm</h3><FinalEvaluationPanel evaluation={selected.quality_report.final_evaluation} /></section>
