    ...
    def build(self, agent: Agent) -> Task:
        ...
        return Task(
            description=(
                ...
                "7. Keep the H1 aligned with the search intent and make headings descriptive. "
                "Use the primary keyword naturally and remove mechanical repetition.\n"
                "8. Remove technical claims that are not supported by the retrieved project knowledge.\n\n"
                "OUTPUT FORMAT:\n"
